    ...
    <Transition name="fade" mode="out-in">
        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
            <div
                ...
                class="cursor-pointer rounded-md bg-bittersweet-base p-4 tracking-widest text-white shadow-sm shadow-peach-base transition-shadow hover:shadow-lg"
            >
                <p class="text-xl uppercase">{{ problem.category }}</p>
